...
from .block.fca import MultiSpectralAttentionLayer
from .block.MFCSAM import SELayer,mfcsa_module_layer_2,mfcsa_module_layer_4
from .block.epsanet import PSAModule_layer_2, PSAModule_layer_4
from .block.epsa_fc import psa_fc_block_layer_2, psa_fc_block_layer_4
from .block.FCSAM import FCSA

def conv1x1(in_planes: int, out_planes: int, stride: int = 1) -> nn.Conv2d:
    return nn.Conv2d(in_planes, out_planes, kernel_size=1, stride=stride, bias=False)

class UMSFAM(nn.Module):
    ...
    def __init__(self, layer1_channel, layer3_channel, conv_kernels = [3, 5, 7, 9], conv_groups = [1, 4, 8, 16]):
        ...
        # FCSAM
        self.selfatten = FCSA(layer3_channel)
        # EPSAnet
        self.att_epsa_2 = PSAModule_layer_2(layer3_channel, layer3_channel, stride=1, conv_kernels=conv_kernels,
                                            conv_groups=conv_groups)
        self.att_epsa_4 = PSAModule_layer_4(layer3_channel, layer3_channel, stride=1, conv_kernels=conv_kernels,
                                            conv_groups=conv_groups)
        # EPSAnet_FCA
        self.att_epsa_fc_2 = psa_fc_block_layer_2(layer3_channel, layer3_channel, stride=1, conv_kernels=conv_kernels,
                                                  conv_groups=conv_groups)
        self.att_epsa_fc_4 = psa_fc_block_layer_4(layer3_channel, layer3_channel, stride=1, conv_kernels=conv_kernels,
                                                  conv_groups=conv_groups)
        # MFCSAM
    ...
    def forward(self, input):
        ...
        # x_3 = self.selfatten(x_3)
        x_3 = self.att_mfcsam_2(x_3)
        # x_3 = self.att_epsa(x_3)
        # x_3 = self.att_epsa_4(x_3)
